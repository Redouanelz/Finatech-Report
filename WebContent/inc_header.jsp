...
<%@taglib uri="/struts-tags" prefix="s" %>    
	...
	<nav  style="margin-top: 100px;">
		<ul class="nav nav-pills nav-stacked" style ="background-color:#f1f1f1;border: solid #cecaca 3px;" role="tablist">
			...
			<s:if test="%{#session.Autorization_users == 'show' && #session.Autorization_config != 'show'}">					
				...
				<li class="dropdown" style="width:205px;margin-left:20px;">
					<a style="cursor: not-allowed;     color: grey;" class="dropdown-toggle" data-toggle="dropdown" class="a2" >Configuration <span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu" style="background-color:#f1f1f1;">
						<li><a style="cursor: not-allowed;     color: grey;" class="a3" style="color:#2c6ad3">Parametrage</a></li>                       
					</ul>
				</li>
			</s:if>
			
			<s:if test="%{#session.Autorization_config == 'show' && #session.Autorization_users != 'show'}">			
				<li class="dropdown" style="width:205px;margin-left:20px;">
					<a style="cursor: not-allowed;  color: grey;" class="dropdown-toggle" data-toggle="dropdown" class="a2" >Gestion Des Utilisateurs <span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu" style="background-color:#f1f1f1;">
						<li><a style="cursor: not-allowed;    color: grey;" class="a3" style="color:#2c6ad3">Nouvel Utilisateur</a></li>
						<li><a style="cursor: not-allowed;    color: grey;" class="a3" style="color:#2c6ad3">Modifier Utilisateur</a></li>
					</ul>
				</li>						
				<li class="dropdown" style="width:205px;margin-left:20px;">
